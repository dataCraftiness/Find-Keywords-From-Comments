...
function FindWords() {
 ...
 /*****************************************************************************************************************/  
  ...
  summarySheet.getRange("A:B").clearContent();  
  ...
  if (waL == waC) {
    ...
    conditionalFormatRules.splice(0, 2);
    ...
    */
    ...
    conditionalFormatRules.push(SpreadsheetApp.newConditionalFormatRule()
                                //.setRanges([summarySheet.getRange(2,7,WhatRow("Nb of comments the Word is in"),1)])
                                .setRanges([summarySheet.getRange(2,7,limit,1)])
                                .whenCellNotEmpty()
